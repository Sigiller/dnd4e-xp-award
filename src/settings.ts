...
export function registerSettings(): void {
  game.settings.register(MODULE_ID, SETTING_SHOW_ON_COMBAT_END, {
    name: game.i18n.localize(`${MODULE_ID}.settings.showOnCombatEnd.name`),
    hint: game.i18n.localize(`${MODULE_ID}.settings.showOnCombatEnd.hint`),
    scope: "world",
    config: true,
    type: Boolean,
    default: true,
  ...
  game.settings.register(MODULE_ID, SETTING_INDIVIDUAL_XP, {
    name: game.i18n.localize(`${MODULE_ID}.settings.individualXp.name`),
    hint: game.i18n.localize(`${MODULE_ID}.settings.individualXp.hint`),
    scope: "world",
    config: true,
    type: Boolean,
    default: false,
